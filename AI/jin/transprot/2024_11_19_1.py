...
class NFCSystem:
    ...
    def show_nfc_gui(self):
        ...
        self.gui_window.geometry("400x300")
...
class DetectionSystem:
        ...
        if identifier != "Unknown":
            try:
                ...
                if response.status_code == 200:
                    ...
                    if token_data:
                        # Pause processing but not display
                        self.pause_event.set()
                        
                        # Show NFC GUI and wait for tagging
                        ...
                        # Close GUI and resume processing
    ...
    def video_capture_thread(self):
        ...
        while self.running:
            ...
            # Always show the frame regardless of pause_event
