...
import org.ssmartoffice.seatservice.global.dto.ErrorResponse
...
import org.ssmartoffice.seatservice.global.const.errorcode.CommonErrorCode
...
class GlobalExceptionHandler : ResponseEntityExceptionHandler() {
    ...
    fun handleAuthorizationDeniedException(ex: AuthorizationDeniedException?): ResponseEntity<Any> {
        val errorCode: ErrorCode = SeatErrorCode.ACCESS_ADMIN_DENIED
        return handleExceptionInternal(errorCode)
    }
